        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid cumque hic id impedit in incidunt inventore numquam quam recusandae, rem repellendus similique sunt veniam! Accusantium cum harum nobis pariatur sint.
                </p>
            </div>
