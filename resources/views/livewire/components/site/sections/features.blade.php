<div class="relative bg-white dark:bg-slate-800 py-16 sm:py-24 lg:py-32">
  <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
    <h2 class="text-base font-semibold tracking-wider text-sky-600 dark:text-sky-500 uppercase">Des solutions pour vous</h2>
    <p class="mt-2 text-3xl font-extrabold text-gray-900 dark:text-slate-100 tracking-tight sm:text-4xl">
    ...
    <div class="mt-12">
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        <div class="pt-6">
          <div class="flow-root bg-gray-50 dark:bg-slate-900 rounded-lg px-6 pb-8">
            <div class="-mt-6">
              <div>
        ...
        <div class="pt-6">
          <div class="flow-root bg-gray-50 dark:bg-slate-900 rounded-lg px-6 pb-8">
            <div class="-mt-6">
              ...
              <h3 class="mt-8 text-lg font-medium text-gray-900 dark:text-slate-100 tracking-tight">Une expertise professionnelle</h3>
              <p class="mt-5 text-base text-gray-500 dark:text-slate-300">
