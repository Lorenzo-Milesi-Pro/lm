                                    ...
                                    <div class="mt-2">
                                        @if($write)
                                            <div id="tabs-1-panel-1" class="p-0.5 -m-0.5 rounded-lg" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0">
                                                ...
                                                <div>
                                                    <textarea wire:model="body"  id="body" class="shadow-sm focus:ring-sky-500 focus:border-sky-500 block w-full sm:text-sm border-gray-300 rounded-md min-h-screen @error('body') border-red-300 @enderror" placeholder="Add your content..."></textarea>
                                                </div>
                                            </div>
                                        @else
